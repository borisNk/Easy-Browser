...
Project created for the purpose of learning Swift language. It shows a custom browser with a WKWebView where can be loaded websites. 
...
2. Locate the file named **Easy Browser.xcodeproj** and click on it to open the Xcode IDE. 
